...
final List<Story> stories = [
  ...
  Story(
    ...
    players: [
      Player(name: "Emperor", isBot: false, asset: '$_path/player4.png'),
      Player(name: "Military", isBot: false, asset: '$_path/player7.png'),
      Player(name: "Nobility", isBot: false, asset: '$_path/player5.png'),
      Player(name: "Alex", isBot: false, asset: '$_path/player3.png'),
      Player(name: "Nobility", isBot: false, asset: '$_path/player6.png'),
      Player(name: "Military", isBot: false, asset: '$_path/player8.png'),
    ],
